import svgPaths from "./svg-h0p38kbi6y";
...
export default function Table() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative rounded-[8px] size-full" data-name="Table">
